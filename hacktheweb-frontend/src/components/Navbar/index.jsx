        ...
        </div>
            {
                isLanding ? 
                    (
                        ...
                        <button className="btn primary-btn" onClick={handleOpenLoginModal} onMouseEnter={onEnter} onMouseLeave={onLeave}>Login/Register</button>
                        </div>
                    )
                :
                    (
                        <div className="buttons-container flex flex-row">
                            ...
                            <button className="btn primary-btn capitalize"  onMouseEnter={onEnter} onMouseLeave={onLeave}>{name ? name :"Profile"}</button>
