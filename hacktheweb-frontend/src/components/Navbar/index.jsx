        ...
        <>
            {
                ...
                :
                    (
                        <>
                        <div className='menu-container flex flex-row w-[44px] h-[44px] flex-grow justify-end items-center'>
                            <Button 
                            id="basic-btton"
                            ...
                            >
                            {
                                profile_url ?
                                (
                                    <img  className='rounded-full profile-image' src={profile_url} alt="user image"/>
                                )
                                :
                                (
                                    <svg className='rounded-full bg-white profile-image' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
