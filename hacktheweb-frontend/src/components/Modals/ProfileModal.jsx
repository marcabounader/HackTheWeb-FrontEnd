  ...
  return (
    ...
    >
      ...
      <div className="form-container flex flex-col gap-5 p-6 pb-0">
        ...
        />
        {profile_image ? (
          <img src={`data:image/png;base64,${profile_image}`} alt="profile image" className=' rounded-full w-[300px] h-[260px]'/>
        ) : (
          <>
          {profile_url ? 
          (      
            <img src={profile_url} alt="profile image" className=' rounded-full w-[300px] h-[260px]'/>
          )
          :
          (
            <svg className=' rounded-full w-[300px] h-[260px] bg-white' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
