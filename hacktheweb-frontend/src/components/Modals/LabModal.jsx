...
const LabModal = ({isStopLoading,handleOpenStopConfirmation,isOpen,handleCloseViewModal,lab,token}) => {
    ...
    return ( 
        ...
        className="z-30 overflow-y-auto bg-[#0D1115] w-[50%] h-[80%] transition-opacity fixed top-1/2 left-1/2 transform  -translate-x-1/2 -translate-y-1/2 dark:border flex flex-col items-center gap-3 shadow-lg py-[10px] px-[20px]"
